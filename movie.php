...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group input-group">
        <div class="input-group-prepend">
            ...
            <input name="Launch_date " class="form-control" placeholder="Launch_date " type="text">
    ...
    <div class="form-group input-group">
        ...
        <input class="form-control" placeholder="duration_time"  name="duration_time"type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
        <div class="input-group-prepend">
            <span class="input-group-text"> <i class="fa fa-user"></i> </span>
